...
public class Dungeonizer : MonoBehaviour {
	...
	public GameObject floorPrefab;
	//o prefab da parede tem que ser 50x50
	public List<GameObject> wallPrefab = new List<GameObject>();	
	...
	//o prefab do canto tem que ser 50x50
	public GameObject cornerPrefab;
	public GameObject cornerPrefab2;
	public GameObject cornerPrefab3;
	public GameObject cornerPrefab4;
	...
	public void Generate()
	{
		...
		for (var y = 0; y < Dungeon.map_size_y; y++) {
			for (var x = 0; x < Dungeon.map_size_x; x++) {
				...
				if ( Dungeon.walls.Contains(tile)) {
					//aqui é onde a parede é instanciada 8 = parede de cima, 9= parede direita, 10=parede de baixo,11=parede esquerda
					GameObject wallPrefabToUse = wallPrefab[0];
					switch (tile)
                    {
						case 8:
							wallPrefabToUse = wallPrefab[Random.Range(0,wallPrefab.Count)];							
							break;
						case 9:
							wallPrefabToUse = wallPrefab3;
							break;
						case 10:
							wallPrefabToUse = wallPrefab4;
							break;
						case 11:
							wallPrefabToUse = wallPrefab5;
							break;
                    }
					...
					if(room != null){
						...
						if (!makeIt3d)
						{
						    //quando eu criar as diversar versoes de parede nao pode por para rodar
                ...
                if (Dungeon.corners.Contains(tile)) {
                    ...
                    {
						case 5:
							cornerPrefabToUse = cornerPrefab2;
							break;
						case 6:
							cornerPrefabToUse = cornerPrefab3;
							break;
						case 7:
							cornerPrefabToUse = cornerPrefab4;
							break;
                    }
					Room room = Dungeon.map[x,y].room;
					if(room != null){
		...
		//OTHERS
		for (int x = 0; x < Dungeon.map_size_x-10; x++) {
			for (int y = 0; y < Dungeon.map_size_y-10; y++) {
